...
InlineKeyboardButton(
            text="🌀sᴜᴘᴘᴏʀᴛ", url="https://telegram.dog/Toukakirishimasupport"
        ),
...
HELP_STRINGS = """
`Hey there! My name is` [ᴍᴇʟɪᴏᴅᴀs]("https://telegra.ph/file/9d1d0233749f315bed972.jpg") 
I'm the captain of seven deadly sins and help admins manage their groups with Some Powerful skills! `Have a look at the following for an idea of some of the things I can help you with.`"""
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@Toukakirishimasupport", "[I won't die](https://telegra.ph/file/9d1d0233749f315bed972.jpg)", parse_mode=ParseMode.MARKDOWN)
        except Unauthorized:
            LOGGER.warning(
